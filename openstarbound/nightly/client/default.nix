...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://nightly.link/OpenStarbound/OpenStarbound/workflows/build/main/OpenStarbound-Linux-Clang-Client.zip";
    sha256 = "sha256-F4dY+qhIYAKWrXz93ReuLPLKIvFdddepuzQ2HgqZdZo=";
  };
