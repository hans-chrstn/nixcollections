...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://nightly.link/OpenStarbound/OpenStarbound/workflows/build/main/OpenStarbound-Linux-Clang-Server.zip";
    sha256 = "sha256-xsTxXeGdywmyt8I5TFg4t+V1Of/5oUBsdzymUREiKKo=";
  };
